...
public class DeadzoneEntityBuilder extends EntityBuilder {
    ...
    public void create() {
        ...
        createComponent(SizeComponent.class).init(Constants.WORLD_WIDTH, 1);

        createComponent(BodyComponent.class).init(BodyBuilder.buildBox(BodyDef.BodyType.StaticBody, new Vector2(Constants.WORLD_WIDTH / 2, 0), Constants.WORLD_WIDTH, 1))
                .setUserData(entity)
                .setSensor(true)
